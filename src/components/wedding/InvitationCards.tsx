        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap gap-3">
              {['Burgundy', 'Khaki', 'Black', 'White'].map((color) => (
                <div
                  key={color}
                  className="px-4 py-2 rounded-full bg-burgundy/10 border border-burgundy/20 font-sans text-burgundy font-medium"
                >
                  {color}
                </div>
              ))}
